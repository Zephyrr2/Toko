            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidde">
                    ...
                    <div>
                        ...
                        <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="{{ url('/register/pegawai') }}">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                        @foreach ($pegawai->reverse() as $pgw)
                            <tr>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-1.5">
                                        <span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                                            <a href="{{ url('/admin/pegawai/edit/' . $pgw->id_user )}}" class="font-medium text-blue-600 hover:underline">
