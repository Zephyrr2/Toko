                        ...
                        @foreach ($barang as $brg)
                            ...
                            <tr>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            <span class="block text-sm font-semibold text-gray-800 ml-10">{{ $brg->nama_barang }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="h-px w-72 whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <span class="block text-sm font-semibold text-gray-800">{{ $brg->harga_barang }}</span>
                                    </div>
                                </td>
                                <td class="h-px w-72 whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <span class="block text-sm font-semibold text-gray-800">{{ $brg->stock }}</span>
                                    </div>
                                </td>
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-1.5">
                                        <span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                                            <a href="{{ url('/admin/barang/edit/' . $brg->id_barang )}}" class="font-medium text-blue-600 hover:underline">
                                                <button class="inline-block border-e p-3 text-white bg-blue-600 hover:bg-blue-700 focus:relative" title="Edit Film">
