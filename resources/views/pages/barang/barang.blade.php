...
@include('partials.sidebar')
    ...
    <div class="p-4 sm:ml-64">
        <H1 class="text-center font-bold text-gray-900 text-xl mb-10">Data Barang</H1>
        <a href="{{ url('/admin/barang/add') }}" class="bg-blue-500 p-3 rounded-md text-white font-semibold mb-7">Tambah Barang</a>
